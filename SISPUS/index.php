    ...
    <div class="container ">
        ...
        <div class="content">
            <ul class="list-group col-md-3 col-xs-2">
                <li class="list-group-item "><a href="index.php?mod=buku"> <i class="fa fa-address-card "></i> <span class="hidden-xs">Data Dokter</span></a></li>
                <li class="list-group-item "><a href="index.php?mod=buku"> <i class="fa fa-address-card "></i> <span class="hidden-xs">Data Pasien</span></a></li>
            </ul>
